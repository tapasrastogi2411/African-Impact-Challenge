      ...
      <Grid className={classes.content} container>
        ...
        <Grid item xs={12}>
          <Typography className={classes.description}>
            Enabling the continent’s aspiring entrepreuners to build
            market-creating innovations, which tackle the country’s biggest
            challenges with technology{" "}
          </Typography>
        </Grid>
        <Grid item>
          <Button className={classes.signUpBtn} component={Link} to="/signup">
            Sign Up
          </Button>
        </Grid>
        <Grid item>
